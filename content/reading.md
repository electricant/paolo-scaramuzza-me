...
* [Inversion and The Power of Avoiding Stupidity](https://fs.blog/inversion/)
	...
	need to think about them forwards and backward. Inversion often forces
	you to uncover hidden beliefs about the problem you are trying to solve."*

* [LTspice: Importing and Exporting WAV & PWL Text Files](https://www.analog.com/en/education/education-library/videos/5579265677001.html)
...
* [How GPS works](https://ciechanow.ski/gps)
	<br/>Very well done. A work of art. The other explanations by the same
	author are great.
...
* [How Not To Sort By Average Rating](https://www.evanmiller.org/how-not-to-sort-by-average-rating.html)
	<br/>An insightful guide on article rating. See also the [related discussion on HN](https://news.ycombinator.com/item?id=29200103)

* [Common Probability Errors to Avoid](https://fs.blog/common-probability-errors/)
...
* [How NOT to Measure Latency](https://www.infoq.com/presentations/latency-response-time/)
	<br/>Interesting overview presentation about how to measure latency and
	the proper usage of percentiles.
...
* [Analog Electronics Tutorials | Analog Devices](https://www.analog.com/en/education/education-library/tutorials/analog-electronics.html)
	<br/>Great tutorials by Analog Devices about analog electronics using
	opamps and the like.
...
* [How to Buy Gifts That People Actually Want](https://www.willpatrick.co.uk/articles/how-to-buy-gifts-that-people-actually-want)
	<br/>The title speaks for itself. The relative
	[discussion on HN](https://news.ycombinator.com/item?id=25267847) is
	also full of useful comments.

* [How to be Indistractable](https://psyche.co/guides/to-become-indistractable-recognise-that-it-starts-within-you)
	<br/>*"When you notice yourself feeling distracted, pause and ask
	yourself what you're feeling. Are you worried? Are you afraid? Then go
	one step deeper. What caused the sensation? How does it feel in your
	body?"*
	<br/>Also related: [Urge Surfing mp3](https://depts.washington.edu/abrc/mbrp/recordings/Urge%20Surfing.mp3)

* [Digital Camera Know-Hows](https://av.jpn.support.panasonic.com/support/global/cs/dsc/knowhow/index.html)
	<br/>Albeit the technical information is dated this tutorial is still to
	the point.

* [How to win at monopoly and piss off your friends](https://kottke.org/16/02/how-to-win-at-monopoly-and-piss-off-your-friends)
